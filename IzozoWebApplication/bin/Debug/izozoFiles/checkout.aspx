...
<div>
    ...
    <div id="content">
       <div style="height: 1000px; margin-right:5px; float:left;">
           ...
           <select id="country"  
                style="margin-left: 0px;font-size:16px; color: #777; border: 1px solid #456879; color: #777; border-radius: 5px; width:32%; height: 50px;font-size:20px;">
           ...
           <select id="Select1"  
                style="margin-left: 0px; height: 22px; border: 1px solid #456879; color: #777; border-radius: 5px; width:32%; height: 50px;font-size:20px;" >
...
<div>
	...
	<header class="top-navbar">
       ...
       <a class="navbar-brand" href="home.aspx">
			...
			<div class="step_progressbar">
             ...
             <asp:LinkButton ID="LinkButton1" style="color: Blue; font-size: 18px;" runat="server"><i class="fa fa-shopping-cart fa-2x" style="color:#bdbdbd"></i>&nbsp;&nbsp;Back to cart</asp:LinkButton>
		</nav>
	</header>
    </div>
	<!-- End header -->
    ...
    <div id="content">
       <div style="height: 1000px; margin-right:5px; float:left;">
			<asp:Label ID="Label5" runat="server" style="font-size: x-large; font-weight: 700; color: Black;" Text="DELIVERY METHOD"></asp:Label><br />
           <asp:Label ID="Label6" runat="server" 
                style="font-size: 20px;  color: Black; border-radius: 5px; border: 1px solid #777; padding: 8px;  border-bottom: none;" 
                Width="850px"><asp:RadioButton ID="RadioButton3" runat="server" />&nbsp;<i class="flaticon-delivery-truck" style="font-weight: bold"></i>&nbsp;Delivery</asp:Label>&nbsp;<br />
           <asp:Label ID="Label7" runat="server" 
                style="font-size: 20px; color: Black; border-radius: 5px; border: 1px solid #777;  padding: 8px;" 
                Width="850px"><asp:RadioButton ID="RadioButton4" runat="server" />&nbsp;<i class="flaticon-shop" style="font-weight: bold"></i>&nbsp;Collection (This option is available for takeaway purchases only)</asp:Label><br /><br />
            <asp:Label ID="Label8" runat="server" style="font-size: x-large; color: Black;" Text="ADD DELIVERY ADDRESS"></asp:Label>
            <br />
            <asp:TextBox ID="TextBox8" style="margin-left: 0px; border: 1px solid #456879; color: #777; border-radius: 5px;width:48%;font-size:20px; float:left;"  placeholder="Recipient name" CssClass="tb5" runat="server" ></asp:TextBox>&nbsp;&nbsp;
           <asp:TextBox ID="TextBox9" style="margin-left: 0px; border: 1px solid #456879; color: #777; border-radius: 5px;width:48%;font-size:20px;" CssClass="tb5" placeholder="Recipient mobile number" runat="server"></asp:TextBox><br /><br />
           <asp:TextBox ID="TextBox10" style="margin-left: 0px; border: 1px solid #456879; color: #777; border-radius: 5px;width:97.7%;font-size:20px;" CssClass="tb5" placeholder="Street address" runat="server"></asp:TextBox><br /><br />
           <asp:TextBox ID="TextBox11" style="margin-left: 0px; border: 1px solid #456879; color: #777; border-radius: 5px;width:97.7%;font-size:20px;" CssClass="tb5" placeholder="Complex/building" runat="server"></asp:TextBox><br /><br />
           <asp:TextBox ID="TextBox12" style="margin-left: 0px ;border: 1px solid #456879; color: #777; border-radius: 5px;width:97.7%;font-size:20px;" CssClass="tb5" placeholder="Suburb" runat="server"></asp:TextBox><br /><br />
           <asp:TextBox ID="TextBox13" style="margin-left: 0px; border: 1px solid #456879; color: #777; border-radius: 5px;width:97.7%;font-size:20px;" CssClass="tb5" placeholder="City" runat="server"></asp:TextBox><br /><br /> 
           <select id="country"  
                style="margin-left: 0px;font-size:16px; color: #777; border: 1px solid #456879; color: #777; border-radius: 5px; width:32%; height: 50px;font-size:20px;">
            <option value="country">Country/Region</option>
            <option value="1">usa</option>
           ...
           <select id="Select1"  
            ...
            <option value="7">North West</option>
                    ...
                    <asp:TextBox ID="TextBox14" style="margin-left: 0px; border: 1px solid #456879; color: #777; border-radius: 5px;width:31%;" CssClass="tb5" placeholder="Postal code" runat="server"></asp:TextBox><br /><br /> 
           <asp:CheckBox ID="CheckBox2" Text="Save this information for next time" style=" color:Black; font-size:20px;" runat="server" />
        </div>          
        <div style="height:400px">
     			<asp:Label ID="Label9" runat="server" style="font-size: x-large; font-weight: 700; color: Black;" Text="ORDER SUMMARY"></asp:Label><br />
                <br />
            <asp:Label ID="Label10" runat="server" Text="Subtotal :" style="color: Black"></asp:Label><br />
            <asp:Label ID="Label11" runat="server" Text="Delivery fee :" style="color: Black"></asp:Label><br />
            <asp:Label ID="Label18" runat="server" Text="Service fee :" style="color: Black"></asp:Label><br />
            <asp:Label ID="Label19" runat="server" Text="Total :" style="font-weight: bold; color: Black"></asp:Label><br /><br />

            <asp:Label ID="Label20" runat="server" Text="" style="font-weight: bold; color: Black; background-color: white; padding: 5px"><i class="fa fa-lock fa-fw"></i>Secure Checkout</asp:Label><br /><br />

            <asp:Button ID="Button2" CssClass="btn1" runat="server" Text="Continue" />
        </div>
  </div>
